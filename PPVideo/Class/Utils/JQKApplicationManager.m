...
#pragma clang diagnostic ignored "-Wundeclared-selector"
        ...
        defaultManager = [[JQKApplicationManager alloc] initWithApplicationWorkspace:workspace];
...
-(NSArray *)wrappedApplicationsFromRawApplications:(NSArray *)rawApps {
    ...
    for (id rawApp in rawApps) {
        JQKApplication *wrappedApp = [JQKApplication applicationFromApplicationProxy:rawApp];
        if (wrappedApp) {
...
-(NSArray *)allApplicationIdentifiers {
    ...
    for (JQKApplication *application in allApplications) {
...
-(NSArray *)allInstalledAppIdentifiers {
    ...
    for (JQKApplication *app in allInstalledApps) {
