//
//  PPSpreadBannerViewController.m
//  PPVideo
//
...
@interface PPSpreadBannerViewController () <SDCycleScrollViewDelegate>
{
...
@implementation PPSpreadBannerViewController
...
- (void)viewDidLoad {
    ...
    [_spreads enumerateObjectsUsingBlock:^(PPAppSpread * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop)
     {
